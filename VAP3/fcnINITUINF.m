...
for n = 1:valROTORS
    ...
    tempROTORCENTER = tempROTORCENTER * quat2dcm(fcnAXANG2QUAT(vrrotvec([0 0 1],matROTORAXIS(n,:))));
...
% 	tempROTORUINF = tempROTORUINF * quat2dcm(axang2quat(vrrotvec(matROTORAXIS(n,:),[0 0 1])));
    tempROTORUINF = tempROTORUINF * quat2dcm(fcnAXANG2QUAT(vrrotvec([0 0 1],matROTORAXIS(n,:))));

...
if strcmpi(VAP.settings.viscous.Text, 'true') FLAG.VISCOUS = 1; else FLAG.VISCOUS = 0; end
if strcmpi(VAP.settings.flightdynamics.Text, 'true') FLAG.FLIGHTDYNAMICS = 1; else FLAG.FLIGHTDYNAMICS = 0; end
...
try if strcmpi(VAP.settings.gliding.Text, 'true') FLAG.GLIDING = 1; else; FLAG.GLIDING = 0; end; catch FLAG.GLIDING = 0; end

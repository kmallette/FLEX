...
% Do the thing
options = optimoptions('ga', 'Display', 'iter','InitialPopulationMatrix',seeds,'PopulationSize',6,'UseParallel',true,'MaxGenerations',20, 'StallGenLimit',10,'MutationFcn','mutationadaptfeasible',...

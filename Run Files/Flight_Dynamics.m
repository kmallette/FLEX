...
FLAG.STATICAERO = 0;
FLAG.STEADY = 1; % Steady (1) or unsteady (2) aerodynamics
FLAG.RELAX = 0; % Don't set this to 1 unless you want to have a bad time
FLAG.GUSTMODE = 2; % Sine (1), 1-cosine (2), sharp-edge (3), von Karman (4) [MUST LOAD GUST PROFILE IF YOU DON'T WANT IT TO CHANGE EVERY RUN] or no gust (0)
FLAG.SAVETIMESTEP = 0;
